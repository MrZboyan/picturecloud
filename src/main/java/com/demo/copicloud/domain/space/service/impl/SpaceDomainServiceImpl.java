package com.demo.copicloud.domain.space.service.impl;
...
import com.demo.copicloud.infrastructure.manager.sharing.DynamicShardingManager;
...
public class SpaceDomainServiceImpl implements SpaceDomainService {
    ...
    public List<Space> listByIds(Set<Long> spaceIds) {
        return spaceRepository.listByIds(spaceIds);
    }
    ...
    public void editSpace(SpaceEditRequest spaceEditRequest, User loginUser) {
        ...
        // 数据校验
        this.validSpace(spaceEntity, false);
        // 判断是否存在
