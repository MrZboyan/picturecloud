package com.demo.copicloud.domain.picture.service;
...
public interface PictureDomainService {
    ...
    Page<Picture> getPicturePage(PictureQueryRequest pictureQueryRequest, QueryWrapper<Picture> queryWrapper);
